...
class LeaveService {
   ...
   */
  async approveLeaveRequest(approvalData: ApproveLeaveRequest): Promise<LeaveRequest> {
    try {
      const response = await apiClient.post<LeaveRequest>(`/leave/requests/${approvalData.requestId}/approve`, {
   ...
   */
  async rejectLeaveRequest(rejectionData: RejectLeaveRequest): Promise<LeaveRequest> {
    try {
      const response = await apiClient.post<LeaveRequest>(`/leave/requests/${rejectionData.requestId}/reject`, {
