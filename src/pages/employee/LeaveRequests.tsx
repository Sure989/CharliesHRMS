...
const LeaveRequests = () => {
  ...
  useEffect(() => {
    const loadRequests = async () => {
      ...
      try {
        setLoading(true);
        const employeeRequests = await api.data.getLeaveRequests('employee', { employeeId: user.employeeId });
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      // Reload requests
      const updatedRequests = await api.data.getLeaveRequests('employee', { employeeId: user?.employeeId });
