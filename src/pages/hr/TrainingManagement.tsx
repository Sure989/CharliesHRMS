...
import { BookOpen, Users, Calendar, Award, GraduationCap, CheckCircle, Clock, Building2, Plus, UserPlus } from 'lucide-react';
      ...
      <div className="space-y-6">
          ...
          <div className="flex space-x-2">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="default" size="sm" className="flex items-center"><Plus className="mr-1 h-4 w-4" />Schedule Training</Button>
              </DialogTrigger>
            ...
            {/* Enroll Employee Button (global) */}
            <Dialog open={isEnrollDialogOpen} onOpenChange={setIsEnrollDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="flex items-center"><UserPlus className="mr-1 h-4 w-4" />Enroll Employee</Button>
              </DialogTrigger>
        ...
        <div className="grid gap-4 md:grid-cols-5">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{certificatesIssued}</div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>All available hospitality training programs</CardDescription>
          </CardHeader>
          <CardContent>
            {programsLoading ? (
