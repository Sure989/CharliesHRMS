...
export function useApi<T>(
  ...
  }, [apiCall, onSuccess, onError]); // config.enableDebugLogs is a constant
  ...
  useEffect(() => {
    ...
    // If you need to refetch on custom dependencies, pass memoized dependencies only
    // To refetch on custom dependencies, use a separate effect in your component with stable values.
...
export function usePaginatedApi<T>(
  ...
  }, [apiCall, pageSize, filters, onSuccess, onError, pagination.page]);
  ...
  }, [filters, initialPage, fetchData]); // Re-fetch when filters, initialPage, or fetchData change
...
export function useRealTimeData<T>(
  ...
  }, [apiCall, onUpdate]); // Remove loading for stability
  ...
  }, [enabled, interval, retryCount, fetchData]); // Remove loading from dependencies
